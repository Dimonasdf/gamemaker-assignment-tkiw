...
// ====================================================== //
// https://www.davetech.co.uk/gamemakercircularhealthbars //
// ====================================================== //

function draw_circular_bar(posX, posY, value, maximum, colour, radius, transparency, width)
{
	if (value > 0)
	{ // no point even running if there is nothing to display (also stops /0
	    ...
	    val = (value/maximum) * numberofsections 
		...
		{ // HTML5 version doesnt like triangle with only 2 sides 
	        ...
	        draw_surface(piesurface,posX-radius, posY-radius)
